...
namespace ConsoleRPG_Team.Entities
{
    internal class EnemyWave
    {
        ...
        public void SpawnEnemyWave()
        {
            ...
            {
                enmies.Add(new Enemy(EnemyType.Minion,"미니언", 1, 10, 1, 10, Item.items[0] , 100 ));
                enmies.Add(new Enemy(EnemyType.Voidspawn,"공허충", 2, 15, 3 , 10 , Item.items[1] , 150));
                enmies.Add(new Enemy(EnemyType.CannonMinion,"대포미니언", 3, 20, 5 , 10, Item.items[2] , 200));
            };
